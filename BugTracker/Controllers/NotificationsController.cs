...
namespace BugTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,NotificationTypeId,RecipientId,SenderId,Title,Message,CreatedDate,Viewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,NotificationTypeId,RecipientId,SenderId,Title,Message,CreatedDate,Viewed")] Notification notification)
        {
