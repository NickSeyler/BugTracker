...
namespace BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,UserId,PropertyName,Description,CreatedDate,OldValue,NewValue")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,UserId,PropertyName,Description,CreatedDate,OldValue,NewValue")] TicketHistory ticketHistory)
        {
